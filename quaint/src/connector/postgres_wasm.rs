...
pub struct SslParams {
    pub(super) certificate_file: Option<String>,
    pub(super) identity_file: Option<String>,
    pub(super) identity_password: Hidden<Option<String>>,
    pub(super) ssl_accept_mode: SslAcceptMode,
}
...
impl PostgresFlavour {
    ...
    pub(super) fn is_cockroach(&self) -> bool {
...
pub struct PostgresUrl {
    pub(super) url: Url,
    pub(super) query_params: PostgresUrlQueryParams,
    pub(super) flavour: PostgresFlavour,
}
