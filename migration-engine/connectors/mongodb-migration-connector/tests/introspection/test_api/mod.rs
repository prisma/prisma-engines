...
use migration_connector::{CompositeTypeDepth, ConnectorParams, IntrospectionContext, MigrationConnector, Warning};
    ...
    U: Future<Output = mongodb::error::Result<()>>,
{
    ...
    RT.block_on(async move {
        ...
        let mut connector = MongoDbMigrationConnector::new(params);
