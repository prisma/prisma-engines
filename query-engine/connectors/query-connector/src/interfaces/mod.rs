...
///! Prisma query-connector interfaces module.
///!
///! Managed query-connector interfaces are for connectors that do not want full control of query AST
...
///!
///! Unmanaged query-connector interfaces take full responsibility of query execution.
