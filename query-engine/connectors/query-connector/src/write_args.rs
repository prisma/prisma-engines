...
use prisma_models::{FieldValues, ModelProjection, ModelRef, PrismaValue, ScalarFieldRef};
...
impl WriteArgs {
    ...
    pub fn as_record_projection(&self, model_projection: ModelProjection) -> Option<FieldValues> {
...
pub fn merge_write_args(loaded_ids: Vec<FieldValues>, incoming_args: WriteArgs) -> Vec<FieldValues> {
