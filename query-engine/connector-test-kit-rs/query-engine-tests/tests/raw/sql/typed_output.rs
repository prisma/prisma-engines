...
mod typed_output {
    ...
    // Ensures output is backward compatible when `improvedQueryRaw` preview feature is not enabled
    #[connector_test(exclude_features("improvedQueryRaw"))]
    async fn all_scalars_backward_compatible(runner: Runner) -> TestResult<()> {
        create_test_data(&runner).await?;
            ...
            "queryRaw": [
              {
                ...
                "dec": {
                  "prisma__type": "float",
                  "prisma__value": 123.45678910000001
                },
                "json": {
                  "prisma__type": "json",
                  "prisma__value": {
    ...
    // Ensures output is backward compatible for SQLite
    #[connector_test(only(Sqlite), schema(common_nullable_types))]
            ...
            "queryRaw": [
              {
                ...
                "float": {
                  "prisma__type": "float",
                  "prisma__value": 1.5432000000000001
                },
                "bytes": {
                  "prisma__type": "string",
                  "prisma__value": "AQID"
