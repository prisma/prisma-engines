...
mod conversion_error {
    ...
    #[connector_test(schema(schema_int), only(Sqlite), exclude(Sqlite("libsql.js"), Sqlite("libsql.js.wasm")))]
    ...
    #[connector_test(schema(schema_bigint), only(Sqlite), exclude(Sqlite("libsql.js"), Sqlite("libsql.js.wasm")))]
