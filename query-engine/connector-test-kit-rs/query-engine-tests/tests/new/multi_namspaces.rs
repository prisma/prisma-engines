...
#[test_suite(capabilities(MultiNamespace))]
mod multi_namespaces {
    use query_engine_tests::*;

    pub fn multi_namespace_simple() -> String {
        let schema = indoc! {
            r#"
            model TestModel {
                #id(id, Int, @id)
    ...
    pub fn multi_namespace_implicit_m2m() -> String {
        let schema = indoc! {
            r#"
                model Loop {
                    id Int @id
    ...
    #[connector_test(schema(multi_namespace_simple), db_namespaces("schema1", "schema2"))]
    ...
    pub fn multi_namespaces_relations() -> String {
        let schema = indoc! {
            r#"
            model ChildModel {
                #id(id, Int, @id)
    ...
    #[connector_test(schema(multi_namespaces_relations), db_namespaces("schema1", "schema2"))]
    ...
    pub fn multi_namespaces_many_to_many_relations() -> String {
        let schema = indoc! {
            r#"
            model Post {
                #id(id, Int, @id)
    ...
    #[connector_test(
        schema(multi_namespaces_many_to_many_relations),
        db_namespaces("schema1", "schema2", "schema3")
    )]
    ...
    #[connector_test(schema(test_filter_in_schema), db_namespaces("schema1", "schema2"))]
    ...
    #[connector_test(schema(multi_namespace_implicit_m2m), db_namespaces("shapes", "objects"))]
