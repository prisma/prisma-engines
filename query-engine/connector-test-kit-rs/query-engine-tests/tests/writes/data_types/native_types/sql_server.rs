...
mod sql_server {
    ...
    async fn other_native_types(runner: Runner) -> TestResult<()> {
        insta::assert_snapshot!(
          ...
          @r###"{"data":{"createOneModel":{"xml":"<meow>purr</meow>","uuid":"ab309dfd-d041-4110-b162-75d7b95fe989","geom":"SRID=4326;POINT (1 2)","geog":"SRID=4326;POINT (1 2)"}}}"###
        );
