        ...
        match other.selection_set {
            ...
            SelectionSet::Single(key, vals) => {
                ...
                argument.push((
                    key.to_string(),
                    PrismaValue::Object(
                        vec![(filters::IN.to_owned(), PrismaValue::List(vals))]
                            .into_iter()
                            .collect(),
                    ),
                ));

                PrismaValue::Object(argument)
            }
    ...
    fn from(conjuctive: Conjuctive) -> Self {
        match conjuctive {
            ...
            Conjuctive::Or(conjuctives) => {
                ...
                let mut map = Vec::new();
                map.push(("OR".to_string(), PrismaValue::List(conditions)));
            ...
            Conjuctive::And(conjuctives) => {
                ...
                let mut map = Vec::new();
                map.push(("AND".to_string(), PrismaValue::List(conditions)));
