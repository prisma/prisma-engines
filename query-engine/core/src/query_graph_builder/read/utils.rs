...
use prisma_models::{Field, ModelProjection, ModelRef, RelationFieldRef, SelectionResult};
use std::sync::Arc;
...
pub fn merge_cursor_fields(selected_fields: ModelProjection, cursor: &Option<SelectionResult>) -> ModelProjection {
    match cursor {
