...
class GroupByHavingQuerySpec extends FlatSpec with Matchers with ApiSpecBase {
  ...
  def create(float: Option[Double], int: Option[Int], s: String, id: Option[String] = None) = {
  ...
  "Using a groupBy with a basic `having` scalar filter" should "work" in {
    // Float, int, s, id
    create(Some(10.1), Some(5), "group1", Some("1"))
    create(Some(5.5), Some(0), "group1", Some("2"))
    create(Some(10), Some(5), "group2", Some("3"))
    create(Some(10), Some(5), "group3", Some("4"))
  ...
  "Using a groupBy with a `having` count scalar filters" should "work" in {
    // Float, int, s, id
    create(None, Some(1), "group1", Some("1"))
    create(None, Some(2), "group1", Some("2"))
    create(None, Some(3), "group2", Some("3"))
    create(None, None, "group2", Some("4"))
    create(None, None, "group3", Some("5"))
    create(None, None, "group3", Some("6"))
  ...
  "Using a groupBy with a `having` average scalar filters" should "work" in {
    // Float, int, s, id
    create(Some(10), Some(10), "group1", Some("1"))
    create(Some(6), Some(6), "group1", Some("2"))
    create(Some(5), Some(3), "group2", Some("3"))
    create(None, None, "group2", Some("4"))
    create(None, None, "group3", Some("5"))
    create(None, None, "group3", Some("6"))
    ...
    var result = server.query(
      s"""{
         ...
         |      float
         |    }
         |  }NestedAtomicNumberOperationsSpec
         |}""".stripMargin,
      project
    )
    result.toString should be("""{"data":{"groupByModel":[{"s":"group1","avg":{"float":8}}]}}""")
    ...
    result = server.query(
      s"""{
         |  groupByModel(by: [s], orderBy: { s: asc }, having: {
         |    OR: [
         |      { float: { avg: { not: { equals: 8.0 }}}},
         |      { float: { avg: { equals: null }}}
         |    ]}
         |  ) {
         |      s
         |      avg {
    ...
    result.toString should be("""{"data":{"groupByModel":[{"s":"group2","avg":{"float":5}},{"s":"group3","avg":{"float":null}}]}}""")
    ...
    result.toString should be("""{"data":{"groupByModel":[{"s":"group1","avg":{"float":8}},{"s":"group2","avg":{"float":5}}]}}""")
  }
  ...
  "Using a groupBy with a `having` sum scalar filters" should "work" in {
    ...
    create(Some(10), Some(10), "group1", Some("1"))
    create(Some(6), Some(6), "group1", Some("2"))
    create(Some(5), Some(5), "group2", Some("3"))
    create(None, None, "group2", Some("4"))
    create(None, None, "group3", Some("5"))
    create(None, None, "group3", Some("6"))
    ...
    result.toString should be("""{"data":{"groupByModel":[{"s":"group1","sum":{"float":16,"int":16}}]}}""")
    ...
    result.toString should be("""{"data":{"groupByModel":[{"s":"group2","sum":{"float":5,"int":5}}]}}""")
    ...
    result.toString should be("""{"data":{"groupByModel":[{"s":"group1","sum":{"float":16,"int":16}},{"s":"group2","sum":{"float":5,"int":5}}]}}""")
  }
  ...
  "Using a groupBy with a `having` min scalar filters" should "work" in {
    // Float, int, s, id
    create(Some(10), Some(10), "group1", Some("1"))
    create(Some(0), Some(0), "group1", Some("2"))
    create(Some(0), Some(0), "group2", Some("3"))
    create(None, None, "group2", Some("4"))
    create(None, None, "group3", Some("5"))
    create(None, None, "group3", Some("6"))
    ...
    result.toString should be("""{"data":{"groupByModel":[{"s":"group1","min":{"float":0,"int":0}},{"s":"group2","min":{"float":0,"int":0}}]}}""")
  ...
  "Using a groupBy with a `having` max scalar filters" should "work" in {
    ...
    create(Some(10), Some(10), "group1", Some("1"))
    create(Some(0), Some(0), "group1", Some("2"))
    create(Some(10), Some(10), "group2", Some("3"))
    create(None, None, "group2", Some("4"))
    create(None, None, "group3", Some("5"))
    create(None, None, "group3", Some("6"))
    ...
    result.toString should be("""{"data":{"groupByModel":[{"s":"group1","max":{"float":10,"int":10}},{"s":"group2","max":{"float":10,"int":10}}]}}""")
