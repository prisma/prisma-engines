...
fn expected_create_one_types_result() -> serde_json::Value {
    json!({
        ...
        "numeric_bit": 4,
        "numeric_boolean": true,
        "date_date": "2020-02-27T00:00:00+00:00",
        "date_datetime": "2020-02-27T19:10:22+00:00",
        "date_timestamp": "2020-02-27T19:11:22+00:00",
        "date_time": "1970-01-01T12:50:01+00:00",
        "date_year": 2012,
        "string_char": "make dolphins easy",
        "string_varchar": "dolphins of varying characters",
        "string_text_tinytext": "tiny dolphins",
...
async fn all_mysql_identifier_types_work(api: &TestApi) -> TestResult {
    let identifier_types = &[
        ...
        ("datetime", "\"2020-02-27T19:10:22+00:00\"", ""),
        ("timestamp", "\"2020-02-27T19:11:22+00:00\"", ""),
        // ("time", "\"1970-01-01T12:50:01+00:00\"", ""),
        ("year", "2091", ""),
        ...
        "data": {
            "findManytypes": [
                expected_create_one_types_result(),
                {
                    ...
                    "numeric_bit": 12,
                    "numeric_boolean": true,
                    "date_date": "2020-03-20T00:00:00+00:00",
                    "date_datetime": "2020-03-20T10:15:00+00:00",
                    "date_timestamp": null,
                    "date_time": "1970-01-01T13:20:01+00:00",
                    "date_year": 1963,
                    "string_char": "abcd",
