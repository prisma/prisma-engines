...
impl DMMFObjectRenderer {
    fn render_input_object(&self, input_object: &InputObjectTypeWeakRef, ctx: &RenderContext) {
    ...
    // WIP dedup code
    fn render_output_object(&self, output_object: &ObjectTypeWeakRef, ctx: &RenderContext) {
