import * as wasmPostgres from '../../../../query-compiler/query-compiler-wasm/pkg/postgresql/query_compiler_fast_bg.js'
import * as wasmMysql from '../../../../query-compiler/query-compiler-wasm/pkg/mysql/query_compiler_fast_bg.js'
import * as wasmSqlite from '../../../../query-compiler/query-compiler-wasm/pkg/sqlite/query_compiler_fast_bg.js'
import * as wasmSqlServer from '../../../../query-compiler/query-compiler-wasm/pkg/sqlserver/query_compiler_fast_bg.js'
import * as wasmCockroachDb from '../../../../query-compiler/query-compiler-wasm/pkg/cockroachdb/query_compiler_fast_bg.js'
...
export async function getQueryCompilerForConnector(
  ...
  if (!initializedModules.has(normalisedConnector)) {
    ...
    const instance = new WebAssembly.Instance(module, {
      './query_compiler_fast_bg.js': engine,
    })
