...
pub fn parse_datamodel(datamodel_string: &str) -> Result<ValidatedDatamodel, errors_and_warnings::ErrorsAndWarnings> {
    parse_datamodel_internal(datamodel_string, false)
}

pub fn parse_datamodel_and_ignore_datasource_urls(
    datamodel_string: &str,
) -> Result<ValidatedDatamodel, errors_and_warnings::ErrorsAndWarnings> {
...
fn parse_datamodel_internal(
    ...
    let mut errors_and_warnings = errors_and_warnings::ErrorsAndWarnings::new();
    ...
    errors_and_warnings.append_warning_vec(sources.warnings);

    match validator.validate(&ast) {
        Ok(mut src) => {
            src.warnings.append(&mut errors_and_warnings.warnings);
            Ok(src)
        }
        Err(mut err) => {
...
pub fn parse_schema_ast(datamodel_string: &str) -> Result<SchemaAst, errors_and_warnings::ErrorsAndWarnings> {
...
pub fn parse_configuration(
    datamodel_string: &str,
) -> Result<ValidatedConfiguration, errors_and_warnings::ErrorsAndWarnings> {
...
fn load_sources(
    ...
    ignore_datasource_urls: bool,
    datasource_url_overrides: Vec<(String, String)>,
) -> Result<ValidatedDatasources, errors_and_warnings::ErrorsAndWarnings> {
...
pub fn render_datamodel_to_string(
    datamodel: &dml::Datamodel,
) -> Result<String, errors_and_warnings::ErrorsAndWarnings> {
...
pub fn render_schema_ast_to_string(schema: &SchemaAst) -> Result<String, errors_and_warnings::ErrorsAndWarnings> {
    let mut writable_string = common::WritableString::new();
...
pub fn render_datamodel_to(
    ...
    datamodel: &dml::Datamodel,
) -> Result<(), errors_and_warnings::ErrorsAndWarnings> {
