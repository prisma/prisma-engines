...
use crate::{Configuration, Datamodel, Datasource, Encryptor, Generator};
...
pub type ValidatedEncryptor = Validated<Encryptor>;
pub type ValidatedEncryptors = Validated<Vec<Encryptor>>;
