...
impl<T: 'static> AttributeListValidator<T> {
    ...
    pub fn validate_and_apply(&self, ast: &dyn ast::WithAttributes, t: &mut T) -> Result<(), MessageCollection> {
    ...
    pub fn serialize(&self, t: &T, datamodel: &dml::Datamodel) -> Result<Vec<ast::Attribute>, MessageCollection> {
        let mut errors = MessageCollection::new();
