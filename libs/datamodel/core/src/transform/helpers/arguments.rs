...
impl<'a> Arguments<'a> {
    ...
    pub fn check_for_duplicate_named_arguments(&self) -> Result<(), MessageCollection> {
    ...
    pub fn check_for_multiple_unnamed_arguments(&self, attribute_name: &str) -> Result<(), MessageCollection> {
    ...
    pub fn check_for_unused_arguments(&self) -> Result<(), MessageCollection> {
        let mut errors = MessageCollection::new();
