...
impl<'a> LowerDmlToAst<'a> {
    ...
    pub fn lower(&self, datamodel: &dml::Datamodel) -> Result<ast::SchemaAst, ErrorsAndWarnings> {
    ...
    pub fn lower_model(&self, model: &dml::Model, datamodel: &dml::Datamodel) -> Result<ast::Model, ErrorsAndWarnings> {
        let mut errors = ErrorsAndWarnings::new();
    ...
    fn lower_enum(&self, enm: &dml::Enum, datamodel: &dml::Datamodel) -> Result<ast::Enum, ErrorsAndWarnings> {
        Ok(ast::Enum {
    ...
    pub fn lower_field(&self, field: &dml::Field, datamodel: &dml::Datamodel) -> Result<ast::Field, ErrorsAndWarnings> {
