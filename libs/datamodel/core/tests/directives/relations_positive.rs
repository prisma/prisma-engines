...
fn allow_multiple_relations() {
    ...
    user_model
        .assert_has_scalar_field("more_posts")
        .assert_relation_to("Post")
        .assert_arity(&dml::FieldArity::List)
    ...
    post_model
        ...
        .assert_relation_name("PostToUser");
    post_model
        .assert_has_scalar_field("posting_user")
        .assert_relation_to("User")
        .assert_arity(&dml::FieldArity::Required)
        .assert_relation_name("more_posts");
}
...
fn allow_complicated_self_relations() {
    ...
    let user_model = schema.assert_has_model("User");
    user_model.assert_has_scalar_field("son").assert_relation_to("User");
    user_model.assert_has_scalar_field("father").assert_relation_to("User");
    user_model.assert_has_scalar_field("husband").assert_relation_to("User");
    user_model.assert_has_scalar_field("wife").assert_relation_to("User");
}
