...
fn must_add_to_fields_on_the_right_side_for_one_to_one_relations() {
    ...
    schema
        ...
        .assert_has_scalar_field("referenceA")
        .assert_relation_to_fields(&["id"]);

    schema
        .assert_has_model("User2")
        .assert_has_scalar_field("referenceB")
        .assert_relation_to_fields(&[]);
...
model Author {
  ...
  authors Blog[]
    ...
    author_model
        .assert_has_scalar_field("authors")
...
fn should_add_back_relations_for_more_complex_cases() {
    ...
    schema
        ...
        .assert_has_scalar_field("category")
    ...
    schema
        .assert_has_model("Post")
        .assert_has_scalar_field("categories")
        .assert_relation_to("PostToCategory")
        .assert_relation_to_fields(&[])
...
fn should_camel_case_back_relation_field_name() {
    ...
    let post_model = schema.assert_has_model("Post");
    post_model
        .assert_has_scalar_field("OhWhatAUser")
...
fn should_add_embed_ids_on_self_relations() {
    ...
    model
        .assert_has_scalar_field("father")
        .assert_relation_to("Human")
...
fn should_not_get_confused_with_complicated_self_relations() {
    ...
    model
        .assert_has_scalar_field("wife")
        .assert_relation_to("Human")
        .assert_relation_name("Marrige")
        .assert_relation_to_fields(&[]);

    model
        .assert_has_scalar_field("husband")
        .assert_relation_to("Human")
        .assert_relation_name("Marrige")
        .assert_relation_to_fields(&["id"]);

    model
        .assert_has_scalar_field("children")
        .assert_relation_to("Human")
        .assert_relation_name("Offspring")
        .assert_relation_to_fields(&[]);

    model
        .assert_has_scalar_field("parent")
        .assert_relation_to("Human")
        .assert_relation_name("Offspring")
        .assert_relation_to_fields(&["id"]);
}
...
fn must_handle_conflicts_with_existing_fields_if_types_are_compatible() {
    ...
    let field = post.assert_has_scalar_field("Blog");
