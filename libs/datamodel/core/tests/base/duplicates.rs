...
fn fail_on_model_type_conflict() {
    ...
    let expectation = expect![[r#"
        [1;91merror[0m: [1mThe model "User" cannot be defined because a alias with that name already exists.[0m
...
fn fail_on_enum_type_conflict() {
    ...
    let expectation = expect![[r#"
        [1;91merror[0m: [1mThe enum "User" cannot be defined because a alias with that name already exists.[0m
          [1;94m-->[0m  [4mschema.prisma:3[0m
        [1;94m   | [0m
        [1;94m 2 | [0m
...
fn fail_on_reserved_name_for_custom_type() {
    ...
    let expectation = expect![[r#"
        ...
        [1;94m   | [0m
        [1;94m   | [0m
        [1;94m 1 | [0malias [1;91mInt[0m = String
        [1;94m   | [0m
    "#]];
