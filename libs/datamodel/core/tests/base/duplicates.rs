...
fn multiple_indexes_with_same_autogenerated_name_trigger_datamodel_validation() {
    ...
    let expectation = expect![[r#"
        [1;91merror[0m: [1mError parsing attribute "@unique": The given constraint name `User_email_name_key` has to be unique in the following namespace: pk, key, idx global. Please provide a different name using the `map` argument.[0m
          [1;94m-->[0m  [4mschema.prisma:6[0m
        [1;94m   | [0m
        [1;94m 5 | [0m
        [1;94m 6 | [0m[1;91mmodel User {[0m
        [1;94m 7 | [0m  id     Int    @id @default(autoincrement())
        [1;94m 8 | [0m  email  String
        [1;94m 9 | [0m  name   String
        [1;94m10 | [0m
        [1;94m11 | [0m  @@unique([email, name])
        [1;94m12 | [0m  @@unique([email, name])
        [1;94m13 | [0m}
        [1;94m   | [0m
        [1;91merror[0m: [1mError parsing attribute "@unique": The given constraint name `User_email_name_key` has to be unique in the following namespace: pk, key, idx global. Please provide a different name using the `map` argument.[0m
          [1;94m-->[0m  [4mschema.prisma:6[0m
