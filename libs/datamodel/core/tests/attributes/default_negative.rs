...
fn named_default_constraints_cannot_have_duplicate_names() {
    ...
    let expectation = expect![[r#"
        [1;91merror[0m: [1mError parsing attribute "@default": The given constraint name `reserved` has to be unique in the following namespace: pk, fk, df global. Please provide a different name using the `map` argument.[0m
          [1;94m-->[0m  [4mschema.prisma:13[0m
        [1;94m   | [0m
        [1;94m12 | [0m  id Int @id @default(autoincrement())
...
fn named_default_constraints_cannot_clash_with_pk_names() {
    ...
    let expectation = expect![[r#"
        ...
        [1;94m13 | [0m  a  String @default("asdf", [1;91mmap: "reserved"[0m)
        [1;94m   | [0m
        [1;91merror[0m: [1mError parsing attribute "@id": The given constraint name `reserved` has to be unique in the following namespace: pk, fk, df global. Please provide a different name using the `map` argument.[0m
...
fn named_default_constraints_cannot_clash_with_fk_names() {
    ...
    let expectation = expect![[r#"
        ...
        [1;94m   | [0m
        [1;91merror[0m: [1mError parsing attribute "@relation": The given constraint name `reserved` has to be unique in the following namespace: pk, fk, df global. Please provide a different name using the `map` argument.[0m
          [1;94m-->[0m  [4mschema.prisma:9[0m
        [1;94m   | [0m
