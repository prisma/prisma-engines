...
fn invalid_name_for_compound_id_must_error() {
    ...
    let expectation = expect![[r#"
        ...
        [1;94m   | [0m
        [1;94m10 | [0m
        [1;94m11 | [0m  @@[1;91mid([name, identification], name: "Test.User")[0m
        [1;94m   | [0m
    "#]];
...
fn naming_id_to_a_field_name_should_error() {
    ...
    let expectation = expect![[r#"
        ...
        [1;94m   | [0m
        [1;94m 6 | [0m    
        [1;94m 7 | [0m[1;91mmodel User {[0m
        [1;94m 8 | [0m  used           Int
        [1;94m 9 | [0m  name           String
        [1;94m10 | [0m  identification Int
        [1;94m11 | [0m
        [1;94m12 | [0m  @@id([name, identification], name: "used")
        [1;94m13 | [0m}
        [1;94m   | [0m
    "#]];
...
fn mapping_id_with_a_name_that_is_too_long_should_error() {
    ...
    let expectation = expect![[r#"
        ...
        [1;94m   | [0m
        [1;94m10 | [0m
        [1;94m11 | [0m  @@[1;91mid([name, identification], map: "IfYouAreGoingToPickTheNameYourselfYouShouldReallyPickSomethingShortAndSweetInsteadOfASuperLongNameViolatingLengthLimits")[0m
        [1;94m   | [0m
        ...
        [1;94m   | [0m
        [1;94m14 | [0mmodel User1 {
        [1;94m15 | [0m  name           String @[1;91mid(map: "IfYouAreGoingToPickTheNameYourselfYouShouldReallyPickSomethingShortAndSweetInsteadOfASuperLongNameViolatingLengthLimitsHereAsWell")[0m
        [1;94m   | [0m
    "#]];
...
fn name_on_field_level_id_should_error() {
    ...
    let expectation = expect![[r#"
        ...
        [1;94m   | [0m
        [1;94m 7 | [0mmodel User {
        [1;94m 8 | [0m  invalid           Int @id([1;91mname: "THIS SHOULD BE MAP INSTEAD"[0m)
        [1;94m   | [0m
    "#]];
