...
async fn identity_introspects_to_sequence_with_default_settings_v_24_3(api: TestApi) {
    let sql = r#"
    CREATE TABLE "myTable" (
...
async fn identity_introspects_to_sequence_with_default_settings_v_25_1(api: TestApi) {
    let sql = r#"
    CREATE TABLE "myTable" (
        id   INT4 GENERATED BY DEFAULT AS IDENTITY,
        name STRING NOT NULL,
...
async fn identity_introspects_to_sequence_with_default_settings_v_25_2(api: TestApi) {
    let sql = r#"
    CREATE TABLE "myTable" (
        id   INT4 GENERATED BY DEFAULT AS IDENTITY,
        name STRING NOT NULL,
...
#[test_connector(tags(CockroachDb243))]
async fn scalar_list_defaults_work_on_24_3(api: &mut TestApi) -> TestResult {
    let schema = r#"
...
#[test_connector(tags(CockroachDb251))]
async fn scalar_list_defaults_work_on_25_1(api: &mut TestApi) -> TestResult {
    let schema = r#"
        CREATE TYPE "color" AS ENUM ('RED', 'GREEN', 'BLUE');
...
#[test_connector(tags(CockroachDb252))]
async fn scalar_list_defaults_work_on_25_2(api: &mut TestApi) -> TestResult {
    let schema = r#"
        CREATE TYPE "color" AS ENUM ('RED', 'GREEN', 'BLUE');
