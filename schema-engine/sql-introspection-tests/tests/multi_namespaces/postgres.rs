...
async fn multiple_namespaces_w_duplicate_sanitized_table_names_are_introspected(api: &mut TestApi) -> TestResult {
...
async fn multiple_namespaces_w_duplicate_enums_are_introspected(api: &mut TestApi) -> TestResult {
    let schema_name = "first";
    let other_name = "second";
    let setup = formatdoc! {
        r#"
...
async fn multiple_namespaces_w_duplicate_models_are_reintrospected(api: &mut TestApi) -> TestResult {
    let schema_name = "first";
    let other_name = "second";
    let setup = formatdoc! {
        r#"
...
async fn multiple_namespaces_w_duplicate_models_are_reintrospected_never_renamed(api: &mut TestApi) -> TestResult {
    let schema_name = "first";
    let other_name = "second";
    let setup = formatdoc! {
        r#"
...
async fn multiple_namespaces_w_duplicate_enums_are_reintrospected(api: &mut TestApi) -> TestResult {
    let schema_name = "first";
    let other_name = "second";
    let setup = formatdoc! {
        r#"
...
#[test_connector(tags(Postgres))]
async fn multiple_namespaces_w_enums_without_schemas_are_not_introspected(api: &mut TestApi) -> TestResult {
    let schema_name = api.schema_name();
    let other_name = "second";
