...
use crate::migrations::multi_namespaces::*;
use sql_migration_tests::test_api::*;
use sql_schema_describer::DefaultValue;

#[test_connector(tags(Postgres), preview_features("multiSchema"), namespaces("one", "prisma-tests"))]
fn apply_migrations_with_multiple_namespaces_where_one_is_search_path_with_a_foreign_key(api: TestApi) {
...
fn multi_namespaces_tests(_api: TestApi) {
