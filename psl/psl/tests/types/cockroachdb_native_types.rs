...
fn cockroach_specific_native_types_are_valid() {
    let schema = indoc! {r#"
        ...
        model NativeTypesTest {
          ...
          geomcol1    GeoJson  @db.Geometry(Geometry, 4326)
          geomcol2    GeoJson  @db.Geometry(GeometryZ, 4326)
          geomcol3    GeoJson  @db.Geometry(GeometryM, 4326)
          geomcol4    GeoJson  @db.Geometry(GeometryZM, 4326)
          geomcol5    GeoJson  @db.Geometry(Point, 4326)
          geomcol6    GeoJson  @db.Geometry(PointZ, 4326)
          geomcol7    GeoJson  @db.Geometry(PointM, 4326)
          geomcol8    GeoJson  @db.Geometry(PointZM, 4326)
          geomcol9    GeoJson  @db.Geometry(Point, 4326)
          geomcol10   GeoJson  @db.Geometry(PointZ, 4326)
          geomcol11   GeoJson  @db.Geometry(PointM, 4326)
          geomcol12   GeoJson  @db.Geometry(PointZM, 4326)
          geomcol13   GeoJson  @db.Geometry(LineString, 4326)
          geomcol14   GeoJson  @db.Geometry(LineStringZ, 4326)
          geomcol15   GeoJson  @db.Geometry(LineStringM, 4326)
          geomcol16   GeoJson  @db.Geometry(LineStringZM, 4326)
          geomcol17   GeoJson  @db.Geometry(Polygon, 4326)
          geomcol18   GeoJson  @db.Geometry(PolygonZ, 4326)
          geomcol19   GeoJson  @db.Geometry(PolygonM, 4326)
          geomcol20   GeoJson  @db.Geometry(PolygonZM, 4326)
          geomcol21   GeoJson  @db.Geometry(MultiPoint, 4326)
          geomcol22   GeoJson  @db.Geometry(MultiPointZ, 4326)
          geomcol23   GeoJson  @db.Geometry(MultiPointM, 4326)
          geomcol24   GeoJson  @db.Geometry(MultiPointZM, 4326)
          geomcol25   GeoJson  @db.Geometry(MultiLineString, 4326)
          geomcol26   GeoJson  @db.Geometry(MultiLineStringZ, 4326)
          geomcol27   GeoJson  @db.Geometry(MultiLineStringM, 4326)
          geomcol28   GeoJson  @db.Geometry(MultiLineStringZM, 4326)
          geomcol29   GeoJson  @db.Geometry(MultiPolygon, 4326)
          geomcol30   GeoJson  @db.Geometry(MultiPolygonZ, 4326)
          geomcol31   GeoJson  @db.Geometry(MultiPolygonM, 4326)
          geomcol32   GeoJson  @db.Geometry(MultiPolygonZM, 4326)
          geomcol33   GeoJson  @db.Geometry(GeometryCollection, 4326)
          geomcol34   GeoJson  @db.Geometry(GeometryCollectionZ, 4326)
          geomcol35   GeoJson  @db.Geometry(GeometryCollectionM, 4326)
          geomcol36   GeoJson  @db.Geometry(GeometryCollectionZM, 4326)
          geogcol1    GeoJson  @db.Geography(Geometry, 4326)
          geogcol2    GeoJson  @db.Geography(GeometryZ, 4326)
          geogcol3    GeoJson  @db.Geography(GeometryM, 4326)
          geogcol4    GeoJson  @db.Geography(GeometryZM, 4326)
          geogcol5    GeoJson  @db.Geography(Point, 4326)
          geogcol6    GeoJson  @db.Geography(PointZ, 4326)
          geogcol7    GeoJson  @db.Geography(PointM, 4326)
          geogcol8    GeoJson  @db.Geography(PointZM, 4326)
          geogcol9    GeoJson  @db.Geography(Point, 4326)
          geogcol10   GeoJson  @db.Geography(PointZ, 4326)
          geogcol11   GeoJson  @db.Geography(PointM, 4326)
          geogcol12   GeoJson  @db.Geography(PointZM, 4326)
          geogcol13   GeoJson  @db.Geography(LineString, 4326)
          geogcol14   GeoJson  @db.Geography(LineStringZ, 4326)
          geogcol15   GeoJson  @db.Geography(LineStringM, 4326)
          geogcol16   GeoJson  @db.Geography(LineStringZM, 4326)
          geogcol17   GeoJson  @db.Geography(Polygon, 4326)
          geogcol18   GeoJson  @db.Geography(PolygonZ, 4326)
          geogcol19   GeoJson  @db.Geography(PolygonM, 4326)
          geogcol20   GeoJson  @db.Geography(PolygonZM, 4326)
          geogcol21   GeoJson  @db.Geography(MultiPoint, 4326)
          geogcol22   GeoJson  @db.Geography(MultiPointZ, 4326)
          geogcol23   GeoJson  @db.Geography(MultiPointM, 4326)
          geogcol24   GeoJson  @db.Geography(MultiPointZM, 4326)
          geogcol25   GeoJson  @db.Geography(MultiLineString, 4326)
          geogcol26   GeoJson  @db.Geography(MultiLineStringZ, 4326)
          geogcol27   GeoJson  @db.Geography(MultiLineStringM, 4326)
          geogcol28   GeoJson  @db.Geography(MultiLineStringZM, 4326)
          geogcol29   GeoJson  @db.Geography(MultiPolygon, 4326)
          geogcol30   GeoJson  @db.Geography(MultiPolygonZ, 4326)
          geogcol31   GeoJson  @db.Geography(MultiPolygonM, 4326)
          geogcol32   GeoJson  @db.Geography(MultiPolygonZM, 4326)
          geogcol33   GeoJson  @db.Geography(GeometryCollection, 4326)
          geogcol34   GeoJson  @db.Geography(GeometryCollectionZ, 4326)
          geogcol35   GeoJson  @db.Geography(GeometryCollectionM, 4326)
          geogcol36   GeoJson  @db.Geography(GeometryCollectionZM, 4326)
        }
    "#};
