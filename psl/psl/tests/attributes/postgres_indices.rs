...
fn hash_index_disallows_ops() {
    ...
    let expectation = expect![[r#"
        ...
        [1;94m   | [0m
        [1;94m13 | [0m
        [1;94m14 | [0m  [1;91m@@index([a(ops: Int4MinMaxOps)], type: Hash)[0m
        [1;94m   | [0m
    "#]];
...
fn btree_index_disallows_ops() {
    ...
    let expectation = expect![[r#"
        ...
        [1;94m   | [0m
        [1;94m13 | [0m
        [1;94m14 | [0m  [1;91m@@index([a(ops: Int4MinMaxOps)], type: BTree)[0m
        [1;94m   | [0m
    "#]];
...
fn disallows_unique_length_prefix() {
    ...
    let expectation = expect![[r#"
        ...
        [1;94m   | [0m
        [1;94m10 | [0mmodel A {
        [1;94m11 | [0m  id String [1;91m@unique(length: 30)[0m @test.VarChar(255)
        [1;94m   | [0m
    "#]];
...
fn operator_classes_not_allowed_with_unique() {
    ...
    let expectation = expect![[r#"
        ...
        [1;94m   | [0m
        [1;94m14 | [0m
        [1;94m15 | [0m  [1;91m@@unique([a(ops: raw("foo")), b(ops: raw("bar"))])[0m
        [1;94m   | [0m
    "#]];
