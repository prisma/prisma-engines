pub mod postgres_datamodel_properties;
...
use self::postgres_datamodel_properties::PostgresDatasourceProperties;
...
pub enum DatasourceConnectorData {
    PostgresData(PostgresDatasourceProperties),
    NoData
}
