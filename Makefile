...
start-cockroach_21_2_0_patched:
	docker-compose -f docker-compose.yml up -d --remove-orphans cockroach_21_2_0_patched && docker exec -t prisma-engines_cockroach_21_2_0_patched_1 ./cockroach sql --insecure -e "SHOW PUBLIC CLUSTER SETTINGS;"
