...
dev-cockroach: start-cockroach_22_1_0_alpha_1
	cp $(CONFIG_PATH)/cockroach_22_1_0_alpha_1 $(CONFIG_FILE)

start-cockroach_21_2_0_patched:
	docker-compose -f docker-compose.yml up -d --remove-orphans cockroach_21_2_0_patched && docker exec -it prisma-engines-cockroach_21_2_0_patched-1 ./cockroach sql --insecure -e "SHOW PUBLIC CLUSTER SETTINGS;"
