...
start-cockroach_21_2_0_patched:
	docker-compose -f docker-compose.yml up -d --remove-orphans cockroach_21_2_0_patched && docker-compose exec -t cockroach_21_2_0_patched ./cockroach sql --insecure -e "SHOW PUBLIC CLUSTER SETTINGS;"
