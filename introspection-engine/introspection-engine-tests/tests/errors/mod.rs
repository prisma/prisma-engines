...
async fn bad_connection_string_in_datamodel_returns_nice_error() {
    ...
    let expected_json_error = json!({
        ...
        "data": {
            "is_panic": false,
            "message": "\u{1b}[1;91merror\u{1b}[0m: \u{1b}[1mError validating datasource `db`: The URL for datasource `db` must start with the protocol `postgresql://`.\u{1b}[0m\n  \u{1b}[1;94m-->\u{1b}[0m  \u{1b}[4mschema.prisma:4\u{1b}[0m\n\u{1b}[1;94m   | \u{1b}[0m\n\u{1b}[1;94m 3 | \u{1b}[0m        provider = \"postgresql\"\n\u{1b}[1;94m 4 | \u{1b}[0m        url      = \u{1b}[1;91m\"sqlserver:/localhost:1433;database=prisma-demo;user=SA;password=Pr1sm4_Pr1sm4;trustServerCertificate=true;encrypt=true\"\u{1b}[0m\n\u{1b}[1;94m   | \u{1b}[0m\n",
            "meta": {
                "full_error": "\u{1b}[1;91merror\u{1b}[0m: \u{1b}[1mError validating datasource `db`: The URL for datasource `db` must start with the protocol `postgresql://`.\u{1b}[0m\n  \u{1b}[1;94m-->\u{1b}[0m  \u{1b}[4mschema.prisma:4\u{1b}[0m\n\u{1b}[1;94m   | \u{1b}[0m\n\u{1b}[1;94m 3 | \u{1b}[0m        provider = \"postgresql\"\n\u{1b}[1;94m 4 | \u{1b}[0m        url      = \u{1b}[1;91m\"sqlserver:/localhost:1433;database=prisma-demo;user=SA;password=Pr1sm4_Pr1sm4;trustServerCertificate=true;encrypt=true\"\u{1b}[0m\n\u{1b}[1;94m   | \u{1b}[0m\n",
            },
