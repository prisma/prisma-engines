...
async fn a_table_with_only_an_unsupported_id_with_native_types_is_still_invalid(api: &TestApi) -> crate::TestResult {
    ...
    let dm = indoc! {r#"
        ...
        // model Test {
          // dummy       Int
          /// This type is currently not supported.
          /// The value of this field is generated by the database as: `'08:00:2b:01:02:03'::macaddr`.
          // network_mac Unsupported("macaddr") @id @default(dbgenerated())
        // }
    "#};
...
async fn db_generated_values_should_add_comments(api: &TestApi) -> crate::TestResult {
    ...
    let dm = indoc! {r##"
        model Blog {
          ...
          // point      Unsupported("point")? @default(dbgenerated())
        }
    "##};
