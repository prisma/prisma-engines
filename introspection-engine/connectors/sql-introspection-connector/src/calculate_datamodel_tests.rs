        ...
        schema.tables = vec![Table {
            ...
            columns: vec![
                ...
                Column {
                    ...
                    default: None,
                    comment: Option::from("comment".to_string()),
                    auto_increment: true,
                },
                Column {
                    name: "list".to_string(),
                    ...
                    default: None,
                    comment: Option::from("some comment".to_string()),
                    auto_increment: false,
                },
            ],
            indices: vec![],
            ...
            models: vec![
                ...
                Model {
                    ...
                    fields: vec![Field::ScalarField(ScalarField {
                        ...
                        database_name: None,
                        default_value: None,
                        comment_value: Some("comment".to_string()),
                        documentation: None,
                        is_generated: false,
                        is_updated_at: false,
                        is_commented_out: false,
                ...
                Model {
                    ...
                    fields: vec![Field::ScalarField(ScalarField {
                        ...
                        database_name: None,
                        default_value: Some(DMLDefault::new_expression(ValueGenerator::new_autoincrement())),
                        comment_value: Some("some comment".to_string()),
                        documentation: None,
                        is_generated: false,
                        is_updated_at: false,
                        is_commented_out: false,
