...
use crate::{datamodel_calculator::DatamodelCalculatorContext, introspection_helpers::is_prisma_join_table};
...
fn find_ambiguous_relations(ctx: &DatamodelCalculatorContext) -> HashSet<[sql::TableId; 2]> {
