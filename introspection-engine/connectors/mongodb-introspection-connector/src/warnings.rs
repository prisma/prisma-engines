...
pub(crate) fn undecided_field_type(affected: &[(String, String, String)]) -> Warning {
    ...
    Warning {
        code: 101,
        message: "The following fields had data stored in multiple types. The most common type was chosen. If loading data with a type that does not match the one in the data model, the client will crash.".into(),
